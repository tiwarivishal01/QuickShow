...
// Ensure axios points to the correct origin in production
axios.defaults.baseURL = import.meta.env.VITE_BASE_URL || "http://localhost:3000";
// Do not include credentials globally; use Authorization bearer tokens per request
// axios.defaults.withCredentials = true; // removed to avoid CORS with credentials
